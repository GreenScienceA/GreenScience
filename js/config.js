...
const catGradients = {
  ...
  // ── AI & Data Science ──
  tech:        'linear-gradient(135deg, #4A00E0, #8E2DE2)',

  // ── Academic Writing & Research Tools ──
  research:    'linear-gradient(135deg, #2C3E50, #4CA1AF)',

  // ── Ecology ──
  ecology:     'linear-gradient(135deg, #11998E, #38EF7D)',

  // ── Chemistry & Math ──
  science:     'linear-gradient(135deg, #E44D26, #F16529)',
...
const contactLinks = [
  {
    ...
    url:   'mailto:greenscience04@gmail.com',
...
const serviceEmail = 'greenscience04@gmail.com';
